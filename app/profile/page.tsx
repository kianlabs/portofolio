    ...
    <PageTransition>
      <div style={{ padding: "20px 20px", maxWidth: "900px", margin: "0 auto", width: "100%" }}>
        ...
        <div style={{ marginBottom: "14px" }}>
          <span style={{ fontSize: "13px", letterSpacing: "0.14em", color: "var(--text-dim)" }}>DIRECTORY / PROFILE</span>
        </div>
        ...
        <section aria-label="About" style={{ marginBottom: "14px" }}>
          ...
          <div style={{ fontSize: "14px", color: "var(--text-dim)", letterSpacing: "0.08em", marginBottom: "8px", display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <div style={{ maxWidth: "600px", display: "flex", flexDirection: "column", gap: "12px" }}>
            <p style={{ fontSize: "17px", color: "var(--text-main)", lineHeight: "1.8" }}>
            ...
            <p style={{ fontSize: "17px", color: "var(--text-sec)", lineHeight: "1.8" }}>
        ...
        <section aria-label="Capabilities" style={{ marginBottom: "14px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            {capabilities.map((cap, i) => (
              ...
              >
                <span style={{ fontSize: "13px", color: "var(--text-dim)", letterSpacing: "0.06em", paddingTop: "1px" }}>[{cap.index}]</span>
                <span style={{ fontSize: "14px", color: "var(--text-sec)", letterSpacing: "0.1em", textTransform: "uppercase", fontWeight: 500 }}>{cap.label}</span>
                <span style={{ fontSize: "15px", color: "var(--text-main)", lineHeight: "1.6" }}>{cap.items}</span>
              </div>
            ))}
          </div>
        </section>
